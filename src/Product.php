<?php
/**
 * The product model class for pearlfibers SDK
 *
...
/**
 * Product model for pearlfibers SDK.
 */
class Product {
	/**
	 ...
	 * Root api endpoint.
	 */
	const API_URL = 'https://api.pearlfibers.com/';
	/**
	 * pearlfibers_SDK_Product constructor.
	 *
	...
	public function get_store_url() {
		...
		if ( strpos( $this->store_url, '/pearlfibers.com' ) !== false ) {
			return 'https://store.pearlfibers.com/';
		}
