<?php
/**
 * The rollback class for pearlfibers SDK.
 *
...
class Rollback extends Abstract_Module {
	...
	/**
	 * Set the rollback hook. Strangely, this does not work if placed in the pearlfibers_SDK_Rollback class, so it is being called from there instead.
	 */
