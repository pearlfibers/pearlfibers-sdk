<?php
/**
 * The logger model class for pearlfibers SDK
 *
...
/**
 * Logger module for pearlfibers SDK.
 */
class Logger extends Abstract_Module {
	/**
	 * Endpoint where to collect logs.
	 */
	const TRACKING_ENDPOINT = 'https://api.pearlfibers.com/tracking/log';
	...
	public function setup_notification() {
		...
		add_filter( 'pearlfibers_sdk_registered_notifications', [ $this, 'add_notification' ] );
